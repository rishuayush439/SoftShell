        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 max-w-xs mb-6">
              SoftSell helps businesses recover value from unused software licenses through our secure, efficient marketplace.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">support@softsell.com</li>
              <li className="text-gray-400">+1 (555) 123-4567</li>
              <li className="text-gray-400">123 Tech Lane <br />San Francisco, CA 94107</li>
            </ul>
          </div>
        </div>
